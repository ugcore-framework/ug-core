Language['en'] = {
    ...
    -- Kick Reasons --
    ------------------
    ['player_already_ingame'] = 'You are already in-game!',
    ['identifier_missing'] = 'Couldn\'t find your license!',
    ['onesync_required'] = 'You must turn ON OneSync to join the server. Current OneSync state: %s',
    ['database_connection_failed'] = 'Couldn\'t connect to the server\'s database!',
